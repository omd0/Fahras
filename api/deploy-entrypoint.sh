...
echo "Starting FrankenPHP with custom Caddyfile on port ${PORT:-8080}..."
exec php artisan octane:start --server=frankenphp --caddyfile=Caddyfile.production --port=${PORT:-8080}
