...
import type { CreateProjectData, Program } from '@/types';
      ...
      <Grid size={{ xs: 12 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
            ...
            <Typography variant="h6" component="h2" sx={{ color: 'primary.main', fontWeight: 700, fontSize: '1.3rem' }}>
              Basic Information
            </Typography>
          </Box>
          ...
          <Grid container spacing={4}>
            <Grid size={{ xs: 12 }}>
              <FormControl fullWidth required error={!!validationErrors.program_id}>
            ...
            <Grid size={{ xs: 12, md: showStatus ? 4 : 6 }}>
              <TextField
                fullWidth
                label="Academic Year"
      ...
      <Grid size={{ xs: 12 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
            ...
            <Typography variant="h6" component="h2" sx={{ color: 'success.main', fontWeight: 700, fontSize: '1.3rem' }}>
              Keywords & Tags
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'flex', gap: 2, mb: 3, flexWrap: 'wrap' }}>
            <TextField
              ...
              sx={{ minWidth: 200 }}
            />
            <Button variant="outlined" color="success" onClick={onAddKeyword} disabled={!newKeyword.trim()} startIcon={<AddIcon />} sx={{ fontWeight: 600 }}>
              Add Keyword
            </Button>
          </Box>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1.5 }}>
            {(formData.keywords || []).length === 0 ? (
              ...
              (formData.keywords || []).map((keyword, index) => (
                <Chip key={index} label={keyword} onDelete={() => onRemoveKeyword(keyword)} color="success" variant="outlined" sx={{ fontWeight: 600 }} />
              ))
            )}
          </Box>
        </Paper>
