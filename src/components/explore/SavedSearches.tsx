...
import type { SavedSearch, SearchFilters, CreateSavedSearchData } from '@/types';
      ...
      >
        ...
        >
          <Stack direction="row" spacing={1} alignItems="center">
            <BookmarkFilledIcon sx={{ color: theme.palette.text.primary }} />
        ...
        <DialogContent sx={{ pt: 3 }}>
          {loading ? (
            ...
            <Box sx={{ textAlign: 'center', py: 4 }}>
              <BookmarkIcon sx={{ fontSize: 64, color: theme.palette.text.secondary, mb: 2 }} />
                    ...
                    <ListItemSecondaryAction>
                      <Stack direction="row" spacing={0.5}>
                        <Tooltip title={search.is_default ? t('Default search') : t('Set as default')}>
                          ...
                          >
                            {search.is_default ? (
                              <StarIcon sx={{ fontSize: 20, color: theme.palette.text.primary }} />
                            ) : (
