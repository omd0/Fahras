...
/**
 * TVTCLogo Component - TVTC institutional logo
 *
 * Features:
 * - Multiple sizes: small, medium, large
 * - Multiple variants: full (icon + text), icon only, text only
 * - Multiple color modes: primary, secondary, inherit
 *
 * Migrated from web/src/components/TVTCLogo.tsx
 */
