...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ open, onClose }) => {
  ...
  const allCommands: CommandItem[] = useMemo(() => [
    ...
    },
    {
      ...
      onSelect: () => { router.push('/dashboard'); onClose(); },
      category: 'Navigation',
      categoryAr: 'التنقل',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/bookmarks'); onClose(); },
      category: 'Navigation',
      categoryAr: 'التنقل',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/profile'); onClose(); },
      category: 'Navigation',
      categoryAr: 'التنقل',
    ...
    // Actions
    {
      ...
      onSelect: () => { router.push('/pr/create'); onClose(); },
      category: 'Actions',
    ...
    // Student Routes
    {
      ...
      onSelect: () => { router.push('/student/my-projects'); onClose(); },
      category: 'Student',
      categoryAr: 'طالب',
    ...
    // Faculty Routes
    {
      ...
      onSelect: () => { router.push('/advisor-projects'); onClose(); },
      category: 'Faculty',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/faculty/pending-approval'); onClose(); },
      category: 'Faculty',
      categoryAr: 'أعضاء هيئة التدريس',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/evaluations'); onClose(); },
      category: 'Faculty',
      categoryAr: 'أعضاء هيئة التدريس',
    ...
    // Admin Routes
    {
      ...
      onSelect: () => { router.push('/users'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    },
    {
      ...
      icon: <CheckCircleIcon fontSize="small" />,
      onSelect: () => { router.push('/approvals'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/admin/projects'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/admin/access-control'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/admin/milestone-templates'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    },
    {
      ...
      labelAr: 'التحليلات',
      icon: <AssessmentIcon fontSize="small" />,
      onSelect: () => { router.push('/analytics'); onClose(); },
      category: 'Admin',
      categoryAr: 'إدارة',
    ...
    // Auth Actions
    {
      ...
      onSelect: () => { router.push('/login'); onClose(); },
      category: 'Account',
      categoryAr: 'الحساب',
    ...
    },
    {
      ...
      onSelect: () => { router.push('/register'); onClose(); },
      category: 'Account',
      categoryAr: 'الحساب',
  ...
  }, [allCommands, isAuthenticated, hasRole]);
