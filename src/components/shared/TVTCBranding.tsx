...
/**
 * TVTCBranding Component - TVTC institutional branding
 *
 * Features:
 * - Multiple variants: header, footer, sidebar, card
 * - Optional description display
 * - Organization name and copyright integration
 *
 * Migrated from web/src/components/TVTCBranding.tsx
 */
