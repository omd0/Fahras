...
export const translationMap: Record<string, string> = {
  ...
  'Bookmark Project': 'حفظ المشروع',
  'Remove Bookmark': 'إزالة الحفظ',
  'My Bookmarks': 'المحفوظات',
  'Bookmarked Projects': 'المشاريع المحفوظة',
  'No bookmarked projects': 'لا توجد مشاريع محفوظة',
  'Login to sync your bookmarks': 'سجل الدخول لمزامنة المحفوظات',
  'X bookmarks synced to your account': 'تمت مزامنة X محفوظة إلى حسابك',
  'Bookmarks saved locally (login to sync)': 'المحفوظات محفوظة محليًا (سجل الدخول للمزامنة)',
  'Start exploring projects and bookmark your favorites to view them here later!': 'ابدأ استكشاف المشاريع واحفظ المفضلة لديك لعرضها هنا لاحقًا!',
